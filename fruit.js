    ...
    return(
        <div className='Category-page' >
            ...
            <motion.div
                ...
                transition={{duration:0.5, delay:0.25}}
            >
                <Product name={'Strawberry Dango'} description={'Tastes great'} image={'starwberrydango.jpg'} path={'/strawberryPage'}/>                <Product name={'Orange Dango'} description={'Tastes great'} image={'orangedango.jpg'}/>
            </motion.div>
            <ScrollToTop/>
        </div>
    );
